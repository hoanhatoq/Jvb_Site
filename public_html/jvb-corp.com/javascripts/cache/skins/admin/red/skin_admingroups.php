...
<td>
{$this->__foreach_loop__id_53d3109b4b2c1($obj,$option)}
...
//===========================================================================
function __foreach_loop__id_53d3109b4b140($obj="",$option=array(),$module='',$list='')
{
;
    $BWHTML = '';
    $vsf_count = 1;
...
// Foreach loop function ifstatement
//===========================================================================
function __foreach_loop__id_53d3109b4b2c1($obj="",$option=array())
{
global $bw;
    $BWHTML = '';
    $vsf_count = 1;
...
{$this->__foreach_loop__id_53d3109b4b140($obj,$option,$module,$list)}
