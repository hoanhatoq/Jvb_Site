...
$BWHTML .= <<<EOF
 value="-1">{$this->getLang()->getWords('all')}</option>
{$this->__foreach_loop__id_53d3109b55973($option)}
</select>
</label>
...
//===========================================================================
function __foreach_loop__id_53d3109b55973($option=array())
{
global $bw;
    $BWHTML = '';
    $vsf_count = 1;
...
{$this->__foreach_loop__id_53d3109b55eb6($obj,$option)}
</select>
</td>
</tr>
...
// Foreach loop function ifstatement
//===========================================================================
function __foreach_loop__id_53d3109b55eb6($obj="",$option=array())
{
global $bw;
    $BWHTML = '';
    $vsf_count = 1;
