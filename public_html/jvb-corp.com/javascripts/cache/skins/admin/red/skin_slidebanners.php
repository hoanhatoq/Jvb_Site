...
class skin_slidebanners extends skin_objectadmin {
...
EOF;
if($this->getSettings()->getKeyGroup($bw->input[0].'_'.$this->modelName.'_website','Website',$bw->input[0].'_'.$this->modelName.'_form')) {
$BWHTML .= <<<EOF

<tr>
<td><label>{$this->getLang()->getWords("website","Địa chỉ web")}</label></td>
<td>
<input size="100" name="{$this->modelName}[website]" type="text" value="{$obj->getWebsite()}" />
</td>
</tr>
