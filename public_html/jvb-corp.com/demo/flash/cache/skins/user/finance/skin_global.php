...
<!--
    <ul class="bxslider">
    {$this->__foreach_loop__id_54097d40cbc49()}
        </ul>
        -->
...
<ul>
{$this->__foreach_loop__id_54097d40cbd29()}
</ul>
</marquee>
</div>
...
//===========================================================================
function __foreach_loop__id_54097d40cbc49()
{
global $bw, $vsLang;
    $BWHTML = '';
    $vsf_count = 1;
...
// Foreach loop function ifstatement
//===========================================================================
function __foreach_loop__id_54097d40cbd29()
{
global $bw, $vsLang;
    $BWHTML = '';
    $vsf_count = 1;
