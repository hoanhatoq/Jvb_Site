...
{$this->__foreach_loop__id_53d3109b5119d($objItems,$option)}
...
//===========================================================================
function __foreach_loop__id_53d3109b5119d($objItems=array(),$option=array())
{
global $bw;
    $BWHTML = '';
    $vsf_count = 1;
...
<tr>
<td colspan="2">
{$this->__foreach_loop__id_53d3109b519bf($obj,$option)}
</td>
</tr>
...
// Foreach loop function ifstatement
//===========================================================================
function __foreach_loop__id_53d3109b519bf($obj="",$option=array())
{
global $bw;
    $BWHTML = '';
    $vsf_count = 1;
...
<div id="footerWrap">
<ul>
<li style="text-align:center;"><a>© Copyright 2014</a></li>
</ul>
</div>
</div>
<style type="text/css">
