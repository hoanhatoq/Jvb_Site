...
{$this->__foreach_loop__id_53d3109b905e7($objItems,$option)}
...
//===========================================================================
function __foreach_loop__id_53d3109b90443($objItems=array(),$option=array(),$blockname='',$block='')
{
;
    $BWHTML = '';
    $vsf_count = 1;
...
// Foreach loop function ifstatement
//===========================================================================
function __foreach_loop__id_53d3109b905e7($objItems=array(),$option=array())
{
global $bw;
    $BWHTML = '';
    $vsf_count = 1;
...
{$this->__foreach_loop__id_53d3109b90443($objItems,$option,$blockname,$block)}
</ul>
</div>
...
{$this->__foreach_loop__id_53d3109b909ec($obj,$option)}
</select>
</td>
</tr>
...
// Foreach loop function ifstatement
//===========================================================================
function __foreach_loop__id_53d3109b909ec($obj="",$option=array())
{
global $bw;
    $BWHTML = '';
    $vsf_count = 1;
