...
<div id="page_tabs">
<ul id="tabs_nav">
        {$this->__foreach_loop__id_53d3109b636b1($list)}
        <li>
...
//===========================================================================
function __foreach_loop__id_53d3109b636b1($list="")
{
global $bw;
    $BWHTML = '';
    $vsf_count = 1;
...
<tr>
    ...
    <td>{$this->vsLang->getWords('lang_symbol','Symbol')}</td>
       ...
       {$this->__foreach_loop__id_53d3109b63963($form)}
</select>
        </td>
    </tr>
<tr>
...
// Foreach loop function ifstatement
//===========================================================================
function __foreach_loop__id_53d3109b63963($form="")
{
global $bw;
    $BWHTML = '';
    $vsf_count = 1;
...
{$this->__foreach_loop__id_53d3109b63b93($showval)}
</table>
</div>
EOF;
//--endhtml--//
...
// Foreach loop function ifstatement
//===========================================================================
function __foreach_loop__id_53d3109b63b93($showval="")
{
global $bw;
    $BWHTML = '';
    $vsf_count = 1;
...
$BWHTML .= <<<EOF
            ...
            {$this->__foreach_loop__id_53d3109b63f99($showall)}
...
// Foreach loop function ifstatement
//===========================================================================
function __foreach_loop__id_53d3109b63e6a($showall="",$module='',$wordlist='')
{
;
    $BWHTML = '';
    $vsf_count = 1;
...
// Foreach loop function ifstatement
//===========================================================================
function __foreach_loop__id_53d3109b63f99($showall="")
{
global $bw,  $vsUser;
    $BWHTML = '';
    $vsf_count = 1;
    ...
    $BWHTML .= <<<EOF
            ...
            {$this->__foreach_loop__id_53d3109b63e6a($showall,$module,$wordlist)}
...
<div >
    ...
    <tr>
        <td>{$this->vsLang->getWords('lang_module','Module')}</td>
            ...
            {$this->__foreach_loop__id_53d3109b6425d($option)}
...
// Foreach loop function ifstatement
//===========================================================================
function __foreach_loop__id_53d3109b6425d($option=array())
{
global $bw ,$langtype;
    $BWHTML = '';
    $vsf_count = 1;
...
$BWHTML .= <<<EOF
    ...
    {$this->__foreach_loop__id_53d3109b644cb($showall)}
...
// Foreach loop function ifstatement
//===========================================================================
function __foreach_loop__id_53d3109b644cb($showall="")
{
global $bw;
    $BWHTML = '';
    $vsf_count = 1;
