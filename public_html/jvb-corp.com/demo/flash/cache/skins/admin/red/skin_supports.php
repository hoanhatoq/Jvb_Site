...
{$this->__foreach_loop__id_53d3109b873b8($objItems,$option)}
...
//===========================================================================
function __foreach_loop__id_53d3109b873b8($objItems=array(),$option=array())
{
global $bw;
    $BWHTML = '';
    $vsf_count = 1;
...
{$this->__foreach_loop__id_53d3109b87b86($obj,$option)}
</select>
<br>
</td>
</tr>
...
// Foreach loop function ifstatement
//===========================================================================
function __foreach_loop__id_53d3109b87b86($obj="",$option=array())
{
global $bw;
    $BWHTML = '';
    $vsf_count = 1;
