...
{$this->__foreach_loop__id_53d3109b652e6($objItems,$option)}
...
//===========================================================================
function __foreach_loop__id_53d3109b652e6($objItems=array(),$option=array())
{
global $bw;
    $BWHTML = '';
    $vsf_count = 1;
...
<td class="status" scope="col"><input 
EOF;
if($item->getStatus()==1) {
$BWHTML .= <<<EOF
checked='checked'
...
$BWHTML .= <<<EOF
 vsId={$item->getId()} onClick="changeStatus(this);" name="chose" type="radio"></td>
