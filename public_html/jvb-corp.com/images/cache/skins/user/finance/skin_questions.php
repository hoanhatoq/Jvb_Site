...
class skin_questions extends skin_objectpublic {
...
{$this->__foreach_loop__id_53d1c6858f547($option)}
</div>
<!--wrapper_content-->
</div>
</div>
...
<ul class="other_post">
{$this->__foreach_loop__id_53d1c6858f78a($obj,$option)}
</ul>
</div>
EOF;
//--endhtml--//
...
// Foreach loop function ifstatement
//===========================================================================
function __foreach_loop__id_53d1c6858f78a($obj="",$option=array())
{
global $bw,$vsPrint;
    $BWHTML = '';
    $vsf_count = 1;
...
//===========================================================================
// <vsf:success:desc::trigger:>
//===========================================================================
function success($option=array()) {global $bw;
