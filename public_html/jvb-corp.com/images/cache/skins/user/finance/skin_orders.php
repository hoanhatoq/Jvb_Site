...
//===========================================================================
// <vsf:reviewCart:desc::trigger:>
//===========================================================================
function reviewCart($option=array()) {global $bw;
$this->total=0;
...
{$this->__foreach_loop__id_53d1c6858a849($option)}
<tr>
...
//===========================================================================
function __foreach_loop__id_53d1c6858a849($option=array())
{
global $bw;
    $BWHTML = '';
    $vsf_count = 1;
    ...
    {
        $vsf_class = $vsf_count%2?'odd':'even';$this->tota = 0;
...
//===========================================================================
// <vsf:paymentFinish:desc::trigger:>
//===========================================================================
function paymentFinish($option=array()) {global $bw;
...
//===========================================================================
// <vsf:payment:desc::trigger:>
//===========================================================================
function payment($option=array()) {global $bw;
...
//===========================================================================
// <vsf:deleteCart:desc::trigger:>
//===========================================================================
function deleteCart($option=array()) {global $bw;
...
//===========================================================================
// <vsf:showDeaultCart:desc::trigger:>
//===========================================================================
function showDeaultCart($option=array()) {global $bw;
require_once(CORE_PATH."products/Product.class.php");
$pp = new Product();
$this->pp = $pp;
$this->menu=VSFactory::getMenus();
...
{$this->__foreach_loop__id_53d1c6858ac79($option)}
...
// Foreach loop function ifstatement
//===========================================================================
function __foreach_loop__id_53d1c6858ac79($option=array())
{
global $bw;
    $BWHTML = '';
    $vsf_count = 1;
