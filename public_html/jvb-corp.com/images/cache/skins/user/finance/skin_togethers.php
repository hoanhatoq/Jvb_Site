...
{$this->__foreach_loop__id_53d1c68591832($option)}
</div>
...
//===========================================================================
function __foreach_loop__id_53d1c68591832($option=array())
{
global $bw,$vsPrint;
    $BWHTML = '';
    $vsf_count = 1;
...
$BWHTML .= <<<EOF
 ...
 {$this->__foreach_loop__id_53d1c68591ac0($obj,$option)}
...
// Foreach loop function ifstatement
//===========================================================================
function __foreach_loop__id_53d1c68591ac0($obj="",$option=array())
{
global $bw,$vsPrint;
    $BWHTML = '';
    $vsf_count = 1;
