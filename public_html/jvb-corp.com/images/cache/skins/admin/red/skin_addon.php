...
{$this->__foreach_loop__id_53d3109b48ad2($arrayObj,$title)}
</select>
</form>
</div>
<script type="text/javascript">
...
//===========================================================================
function __foreach_loop__id_53d3109b48ad2($arrayObj=array(),$title='')
{
global $bw;
    $BWHTML = '';
    $vsf_count = 1;
...
<div id='notifylist' style='display:none;'>
        {$this->__foreach_loop__id_53d3109b48d77($option)}
        <div id='allnotify'>
...
// Foreach loop function ifstatement
//===========================================================================
function __foreach_loop__id_53d3109b48d77($option="")
{
global $bw;
    $BWHTML = '';
    $vsf_count = 1;
