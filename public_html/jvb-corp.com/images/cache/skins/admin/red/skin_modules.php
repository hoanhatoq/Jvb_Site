...
{$this->__foreach_loop__id_53d3109b6ccd9($obj,$option)}
</select>
</td>
</tr>
...
//===========================================================================
function __foreach_loop__id_53d3109b6ccd9($obj="",$option=array())
{
global $bw;
    $BWHTML = '';
    $vsf_count = 1;
...
{$this->__foreach_loop__id_53d3109b6d389($objItems,$option)}
...
// Foreach loop function ifstatement
//===========================================================================
function __foreach_loop__id_53d3109b6d389($objItems=array(),$option=array())
{
    global $bw;
    $BWHTML = '';
    $vsf_count = 1;
...
<div class="core">
<h3>Skin_user</h3>
{$this->__foreach_loop__id_53d3109b6dc68($option)}
</div>
...
<div class="core">
<h3>Skin_admin</h3>
{$this->__foreach_loop__id_53d3109b6dd4e($option)}
</div>
...
<div class="core">
<h3>Database</h3>
{$this->__foreach_loop__id_53d3109b6dea7($option)}
</div>
...
{$this->__foreach_loop__id_53d3109b6e004($option)}
</div>
...
// Foreach loop function ifstatement
//===========================================================================
function __foreach_loop__id_53d3109b6dc68($option=array())
{
      global  $bw;
    $BWHTML = '';
    $vsf_count = 1;
...
// Foreach loop function ifstatement
//===========================================================================
function __foreach_loop__id_53d3109b6dd4e($option=array())
{
      global  $bw;
    $BWHTML = '';
    $vsf_count = 1;
...
// Foreach loop function ifstatement
//===========================================================================
function __foreach_loop__id_53d3109b6dea7($option=array())
{
      global  $bw;
    $BWHTML = '';
    $vsf_count = 1;
...
// Foreach loop function ifstatement
//===========================================================================
function __foreach_loop__id_53d3109b6e004($option=array())
{
      global  $bw;
    $BWHTML = '';
    $vsf_count = 1;
