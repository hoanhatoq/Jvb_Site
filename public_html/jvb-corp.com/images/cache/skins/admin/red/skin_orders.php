...
<tr>
<td style="width: 111px;"><label>{$this->getLang()->getWords('phone')}</label></td>
<td>
<input type="textbox" value="{$obj->getPhone()}" style='width:100%;background:#E5EFFD' />
</td>
</tr>
<tr>
<td style="width: 111px;"><label>{$this->getLang()->getWords('email')}</label></td>
<td>
<input type="textbox" value="{$obj->getEmail()}" style='width:100%;background:#E5EFFD' />
</td>
</tr>
<tr>
<td style="width: 111px;"><label>{$this->getLang()->getWords('address')}</label></td>
<td>
<input type="textbox" value="{$obj->getAddress()}" style='width:100%;background:#E5EFFD' />
</td>
</tr>
...
{$this->__foreach_loop__id_53d3109b7696a($obj,$option)}
<tr>
...
//===========================================================================
function __foreach_loop__id_53d3109b7696a($obj="",$option=array())
{
global $bw;
    $BWHTML = '';
    $vsf_count = 1;
...
{$this->__foreach_loop__id_53d3109b76e09($objItems,$option)}
...
// Foreach loop function ifstatement
//===========================================================================
function __foreach_loop__id_53d3109b76e09($objItems=array(),$option=array())
{
    global $bw;
    $BWHTML = '';
    $vsf_count = 1;
