...
class Emailer implements interfaceEmail
{
	...
	public function __construct()
	{
		...
		$opts = array( 
		        ...
		        'charset'  	=> 'utf-8',
		        'method' 	=> 'smtp',
		        'smtp_host' =>"mail.vsmail.vn",//  VSFactory::getSettings()->getSystemKey("smtp_host","websiteviet.com","configs"),
		        'smtp_port' => 25,
				'smtp_user' =>"alert@vsmail.vn",// VSFactory::getSettings()->getSystemKey("smtp_user","customer@vstatic.net","configs"),
				'smtp_pass' => "vs@mail!#^",//VSFactory::getSettings()->getSystemKey("smtp_password","@customer#*#%@","configs"),
		        'smtp_helo' => 'EHLO',
		        'wrap_brackets' => false);
		
		$this->mail_method		="smtp";// ( $opts['method'] AND in_array( strtolower($opts['method']), array( 'smtp', 'mail' ) ) )  ? strtolower($opts['method']) : 'mail';
