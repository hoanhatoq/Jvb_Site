...
<!-- header -->
	<header>
		<div class="wrapper">
			<h1><a href="index.html" id="logo">ベトパートナー</a></h1>
		...
		<nav>
			<ul id="menu">
				<li class="alpha"><a href="index.html"><span><span>ホーム</span></span></a></li>
				<li id="menu_active"><a href="Vinfo.php"><span><span>ベトナム企業</span></span> </a></li>
				<li><a href="Businesses.html"><span><span>ベトナム情報</span></span></a></li>
			...
			<div class="box pad_bot1">
				<div class="pad marg_top">
					<article class="col1">
						...
						<tr>
						<td width="30">No</td>
						<td width="250">工業団地名</td>
						<td width="100">住所地</td>
						<td width="100">入居企業数</td>
						<td width="80">入居可否</td>
						</tr>
